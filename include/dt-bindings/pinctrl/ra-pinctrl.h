...
#define     IOPORT_PERIPHERAL_ACMPHS    (0x0CUL << IOPORT_PRV_PFS_PSEL_OFFSET)
...
#define     IOPORT_PERIPHERAL_DE_SCI1_3_5_7_9   (0x0DUL << IOPORT_PRV_PFS_PSEL_OFFSET)
...
#define IOPORT_PERIPHERAL_DE_SCI0_2_4_6_8   (0x0EUL << IOPORT_PRV_PFS_PSEL_OFFSET)
...
#define     IOPORT_PERIPHERAL_USB_HS   (0x14UL << IOPORT_PRV_PFS_PSEL_OFFSET)
    ...
    /** Pin will function as a GPT peripheral pin */
#define     IOPORT_PERIPHERAL_GPT2      (0x14UL << IOPORT_PRV_PFS_PSEL_OFFSET)

    /** Pin will function as an SD/MMC peripheral pin */
#define     IOPORT_PERIPHERAL_SDHI_MMC   (0x15UL << IOPORT_PRV_PFS_PSEL_OFFSET)

    /** Pin will function as a GPT peripheral pin */
#define     IOPORT_PERIPHERAL_GPT3      (0x15UL << IOPORT_PRV_PFS_PSEL_OFFSET)
...
#define     IOPORT_PERIPHERAL_CAC       (0x19UL << IOPORT_PRV_PFS_PSEL_OFFSET)
...
#define     IOPORT_PERIPHERAL_CEC   (0x1DUL << IOPORT_PRV_PFS_PSEL_OFFSET)

    /** Pin will function as a PGAOUT peripheral pin */
#define     IOPORT_PERIPHERAL_PGAOUT0   (0x1DUL << IOPORT_PRV_PFS_PSEL_OFFSET)

    /** Pin will function as a PGAOUT peripheral pin */
#define     IOPORT_PERIPHERAL_PGAOUT1   (0x1EUL << IOPORT_PRV_PFS_PSEL_OFFSET)
...
/* Simplified options to use with pin configure */

#define CFG_IRQ_ENABLE (IOPORT_CFG_IRQ_ENABLE | IOPORT_CFG_PORT_DIRECTION_INPUT)
#define CFG_IRQ_ENABLE_PULLUP (IOPORT_CFG_IRQ_ENABLE | IOPORT_CFG_PORT_DIRECTION_INPUT | IOPORT_CFG_PULLUP_ENABLE)
#define CFG_INPUT (IOPORT_CFG_PORT_DIRECTION_INPUT)
#define CFG_OUTPUT_LOW (IOPORT_CFG_PORT_DIRECTION_OUTPUT | IOPORT_CFG_PORT_OUTPUT_LOW)
#define CFG_OUTPUT_HI (IOPORT_CFG_PORT_DIRECTION_OUTPUT | IOPORT_CFG_PORT_OUTPUT_HI)
#define CFG_DEBUG (IOPORT_CFG_PERIPHERAL_PIN | IOPORT_PERIPHERAL_DEBUG)
#define CFG_SCI_EVEN (IOPORT_CFG_PERIPHERAL_PIN | IOPORT_PERIPHERAL_SCI0_2_4_6_8)
#define CFG_SCI_ODD (IOPORT_CFG_PERIPHERAL_PIN | IOPORT_PERIPHERAL_SCI1_3_5_7_9)
#define CFG_GPT1 (IOPORT_CFG_PERIPHERAL_PIN | IOPORT_PERIPHERAL_GPT1)
#define CFG_USB_FS (IOPORT_CFG_PERIPHERAL_PIN | IOPORT_PERIPHERAL_USB_FS)
#define CFG_SPI (IOPORT_CFG_PERIPHERAL_PIN | IOPORT_PERIPHERAL_SPI)
#define CFG_I2C (IOPORT_CFG_PERIPHERAL_PIN | IOPORT_PERIPHERAL_IIC)
